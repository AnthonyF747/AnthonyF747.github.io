...
INSERT INTO Item (ItemName, ItemDescription, SellerID, BuyerID)
VALUES ('Silver Spoon', 'A spoon made of pure silver', 2, null),
('Gold Earring', 'A earring made of gold', 3, null),
('Metal Ring', 'A ring made of an unknown metal', 1, 3),
('Golf Clubs', 'Golf clubs that have seen better days', 4, 4);